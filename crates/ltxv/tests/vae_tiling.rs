...
fn a_single_tile_plan_is_bit_identical_to_the_whole_decode() {
    ...
    let tiled = LtxVaeTiledDecoder::new(&cfg, w.clone(), lt, lh, lw, None, tiling);
...
mod real_1080p {
    ...
    fn the_production_1080p_tile_geometry_agrees_with_the_whole_decode() {
        ...
        let tiled_dec = LtxVaeTiledDecoder::auto(&cfg, w.clone(), lt, lh, lw, Some("gpu"));
    ...
    fn decodes_a_shape_the_whole_path_cannot(lt: u32, lh: u32, lw: u32) {
        ...
        let tiled = LtxVaeTiledDecoder::auto(&cfg, w.clone(), lt, lh, lw, Some("gpu"));
