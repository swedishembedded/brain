...
fn ltxv_av_dit_tiny_matches_reference() {
    ...
    let taps = model.forward(
        v_latent, v_timesteps, v_positions, v_keyframes_mask, v_context, v_context_len, tv, v_sigma,
        a_latent, a_timesteps, a_positions, a_context, a_context_len, ta, a_sigma,
    );
