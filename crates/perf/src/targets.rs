...
//!   race in `apiserve::bridge` - the layer a serving-performance audit's
//!   headline regression actually lived in, and that `ExecutorTarget`/`PagedLlmTarget`
...
/// headline regression would have shown up in, and the synthetic in-process
