...
//! `qwen3omnimoe::talker::decode` -- tiny-config smoke test, same shape as
...
use qwen3omnimoe::talker::{decode, layer_fwd, talker_pipelines, TalkerLayerWeights, TalkerWeights};
