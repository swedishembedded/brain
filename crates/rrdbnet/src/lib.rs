...
//!
//! ```ignore
//! let t = rrdbnet::import::load("RealESRGAN_x4plus.pth")?;
//! let cfg = rrdbnet::config::RrdbConfig::from_tensors(&shapes)?;
//! let net = rrdbnet::model::Rrdb::new(gpu, cfg, &t, h, w, false);
