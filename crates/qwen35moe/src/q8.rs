...
//! decoder — mirrors `crates/qwen3/src/q8.rs`'s recipe (weights quantized once
...
//! respectively), so `crates/qwen35moe/tests/model_i8_smoke.rs` exercises this
...
/// `qwen3::q8::Q8` supports for its sharded pipeline; qwen35 multi-GPU
...
impl Qwen35Q8 {
    ...
    /// step list — identical in spirit to `qwen3::q8::Q8::quant`'s own doc.
