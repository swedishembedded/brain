...
impl Qwen35Config {
    ...
    /// is distinct in the real config stays distinct here
    /// (degenerate/collapsed toy dims hide whole bug classes): d_model,
    ...
    /// weights at import" rule used for qkv/
...
mod tests {
    ...
    fn tiny_config_has_pairwise_distinct_dims_within_each_layer_type() {
        // Degenerate/collapsed toy dims hide whole bug
