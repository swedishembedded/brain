...
//! here. See `docs/models/qwen35/status.md`'s P14 entry for the task this
...
//! `docs/models/qwen35/status.md`'s own P14 note already flags that a literal
...
impl<'a> Topo<'a> {
    ...
    /// confirmed by `docs/models/qwen35/status.md`'s P11b note that this
