...
//! `omni::thinker::layer_fwd`/`layer_decode_step`'s `int8_experts` branch vs.
...
use omni::int8_resident::{ExpertLin8, ThinkerLayerExperts8};
use omni::thinker::{layer_decode_step, layer_fwd, thinker_pipelines, ThinkerLayerCache, ThinkerLayerWeights};
