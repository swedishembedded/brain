...
//! the real transformers reference — reusing `qwenvl::encoder::VisionEncoder`
//! and `qwenvl::encoder::PatchMerger` completely unchanged, at the new
