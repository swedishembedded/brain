...
//! REAL shape on a REAL P40 -- not assumed from FLOP-counting alone, since
//! the result can invert either way
...
/// Best-of-`REPS`, poll_wait-bracketed (a bare-submit loop times host
/// recording, not the device).
