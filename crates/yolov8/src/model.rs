...
impl Yolo {
    ...
    pub fn save(&self, path: &str) {
        let tensors: Vec<(String, Vec<u64>, Vec<f32>)> = self
            ...
            .collect();
        // "brain/yolov8" matches the reserved-vendor
        ...
        // crates/cli/src/model_dir.rs without requiring BRAIN_YOLOV8 to be set.
...
impl model::Model for Yolo {
    ...
    fn set_batch(&self, batch: model::Batch) {
        match batch {
            ...
            _ => panic!("yolov8::Yolo only supports Batch::Tensor"),
        }
    }
