...
const GOLDEN: &str = concat!(env!("CARGO_MANIFEST_DIR"), "/tests/golden/zimage_block.safetensors");
...
fn zimage_block_matches_diffusers() {
    let st = checkpoint::safetensors::read(GOLDEN).expect("read block golden");
