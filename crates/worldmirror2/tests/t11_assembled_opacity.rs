...
fn an_assembled_gaussians_opacity_is_the_learned_merge_weight() {
    ...
    let opts = AssembleOpts { min_opacity: 0.0, max_depth: 0.0, gs_mask_threshold: 0.0, edge_depth_rtol: 0.0, fuse_depth_rtol: 0.0, min_support: 0, conf_percentile: 0.0, surface_align: 0.0 };
