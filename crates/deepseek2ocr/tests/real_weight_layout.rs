...
//! filled by `deepseek2ocr::layout::RowGather` from the projector's output plus
...
use deepseek2ocr::config::{DeepseekOcrConfig, IMAGE_NEWLINE, VIEW_SEPARATOR};
