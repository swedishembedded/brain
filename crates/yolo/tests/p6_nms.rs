...
use yolo::boxmath::{self, dist_to_xyxy, iou, xyxy_to_dist, Letterbox};
use yolo::infer::dfl_decode_dist;
use yolo::{nms, nms_agnostic};
...
fn dfl_decode_target_3_25() {
    ...
    logits[3] = 0.75f32.ln();
    logits[4] = 0.25f32.ln();
    let gpu = gpu_core::Gpu::new_cpu(yolo::net::PIPELINES);
