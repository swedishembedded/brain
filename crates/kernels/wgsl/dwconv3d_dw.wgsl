...
//                       * x[n,c, ot+kt-P, oh+kh-P, ow+kw-P]   (in-range only)
// ACCUMULATES into a pre-zeroed dw (matching conv2d_dw). Bias grad = sum of dy
// over (n,t,h,w) per channel: use the existing bias-grad path after a permute,
// or dwconv3d_db below. fp32, wg64.
