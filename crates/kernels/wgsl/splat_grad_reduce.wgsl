...
// per-gaussian 2D gradient bundle pgrad[N*10] = {v_xy(2), v_conic(3), v_op,
// v_rgb(3), v_depth} and the color grads directly. One invocation per
// gaussian. v_depth is dL/d(this gaussian's camera-space z), summed over the
...
fn main(@builtin(global_invocation_id) gid: vec3<u32>,
    ...
    for (var k = 0u; k < 10u; k = k + 1u) { acc[k] = 0.0; }
    var absacc = 0.0;
