...
**394 kernels.** Every column is a field the kernel DECLARES in its own header
...
* **3/5** — coalesced elementwise or gather — one thread per output, no serial reduction (188 kernels)
