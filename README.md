...
**362 kernels.** Every column is a field the kernel DECLARES in its own header
...
* **2/5** — one thread per output with a serial reduction over a Params-bounded axis (106 kernels)
