...
**370 kernels.** Every column is a field the kernel DECLARES in its own header
...
* **2/5** — one thread per output with a serial reduction over a Params-bounded axis (111 kernels)
...
op (155 kernels), not that this file runs there.
