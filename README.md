...
* **2/5** — one thread per output with a serial reduction over a Params-bounded axis (129 kernels)
...
**quant** — part of the INT8 path (15 kernels) or the int4-weight/int8-activation (W4A8) q4 path (3 kernels).
