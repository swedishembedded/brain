...
Two actions on the `facenet` model (insightface antelopev2):

  * `detect` — boxes, scores and the 5 landmarks, in SOURCE-image pixels;
  * `embed`  — one L2-normalised 512-d ArcFace vector for the primary face.
