...
#   scripts/test-times.sh              # rank every binary
#   scripts/test-times.sh --top 10     # just the worst offenders
#   scripts/test-times.sh --budget 5   # exit non-zero if any binary exceeds 5s
#
