...
# The CSV is committed (crates/kronos/tests/data/synthetic_hourly.csv),
# regenerated by hand with tools/forecast/make_synthetic_ohlcv.py -- so this
# step is a forecast, not a data-generation run, and it costs no network.
