...
SRC = os.environ.get("BRAIN_MOONDREAM3_CKPT") or sys.exit("set BRAIN_MOONDREAM3_CKPT=<moondream3-preview hf checkpoint dir> (no baked-in default: this path is machine-specific)")
