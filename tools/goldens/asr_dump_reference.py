...
Usage:  python tools/goldens/asr_dump_reference.py frontend
"""
import json
import os
import sys
...
RES = os.environ.get("BRAIN_ASR_MIRROR") or sys.exit("set BRAIN_ASR_MIRROR=<asr resources mirror> (no baked-in default: this path is machine-specific)")
