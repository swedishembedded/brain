...
#
#   samples/shell/videogen/ltxv/chain_images_to_video.sh <folder/> [out.mp4] [seconds-per-clip]
#
# <folder/> holds:
...
#
#   MID=1 samples/shell/videogen/ltxv/chain_images_to_video.sh <folder/> ...
#
...
# random-weight DiT instead - see samples/shell/videogen/ltxv/images_to_video.sh's
