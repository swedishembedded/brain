...
pipe fd, and prints the transcription **segments** as each ~1 s window decodes.
    ...
    python3 samples/python/asr/transcribe-mic/transcribe_mic.py --wav $BRAIN_TESTDATA/asr/audio/librispeech_mr_quilter.wav
...
def main() -> int:
    ...
    ap.add_argument("--model", default="brain/nemotronasr", help="ASR model name (brain/nemotronasr | brain/qwen3asr)")
