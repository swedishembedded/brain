...
same reasoning `samples/python/qwen3omnimoe/omni/omni.py` documents for the same choice. The
...
Examples:
  ...
  python3 samples/python/llm/qwen35moe/qwen35moe.py --anthropic localhost:8787 --api-key sk-brain-... \\
      --in-text "2+2=" --out-stdio
...
def main() -> None:
    ...
    # NotImplementedError, matching samples/python/qwen3omnimoe/omni/omni.py's own handling.
    try:
        served = brain.models()
