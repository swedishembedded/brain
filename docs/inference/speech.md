...
### Text-to-speech and voice cloning — `brain/tts`
...
### Speech-to-text — `brain/nemotron` and `brain/qwen-asr`
...
### An assistant that can listen, see, and speak — `brain/omni`
...
### Understanding images and video as text — `brain/fastvlm` and `brain/qwenvl`
